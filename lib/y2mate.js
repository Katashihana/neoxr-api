 ...
 * @param {String} server (avaiable: `id4`, `en60`, `en61`)
 */
...
module.exports = {
   ...
   * @param {String} server (avaiable: `id4`, `en60`, `en61`)
   */
  yta(url, server = 'en88') { return yt(url, '128kbps', 'mp3', '128', server) },
  /**
   * Download YouTube Video as Video via y2mate
   * @param {String} url YouTube Video URL
   * @param {String} server (avaiable: `id4`, `en60`, `en61`)
   */
  ytv(url, server = 'en88') { return yt(url, '360p', 'mp4', '360', server) },
  servers: ['id4', 'en60']
}
